            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        switch (data.code) {
                            case 551: return [2 /*return*/, new eewInfomation_1.EEWInfomation(data)];
                            case 555: return [2 /*return*/, new areapeers_1.Areapeers(data)];
                            case 556: return [2 /*return*/, new detaileew_1.DetailEEW(data)];
                            case 554: return [2 /*return*/, new eew_1.EEW(data)];
                            case 552: return [2 /*return*/, new tsunami_1.Tsunami(data)];
                            default: return [2 /*return*/, null];
                        }
                        return [2 /*return*/];
                }
            });
